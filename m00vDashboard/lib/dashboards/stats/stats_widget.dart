  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<RidesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RidesRecord> statsRidesRecordList = snapshot.data!;
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            AutoSizeText(
                                                              formatNumber(
                                                                functions.totalSum(statsRidesRecordList
                                                                    .where((e) =>
                                                                        e.paid)
                                                                    .toList()
                                                                    .map((e) =>
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          AutoSizeText(
                                                            functions
                                                                .ridesToday(statsRidesRecordList
                                                                    .map((e) =>
                                                                        e.startTime)
                                                                    .withoutNulls
                                                                    .toList())
                                          ...
                                          Expanded(
                                            child: Container(
                                              ...
                                              child: FlutterFlowLineChart(
                                                data: [
                                                  FFLineChartData(
                                                    xData: statsRidesRecordList
                                                        .where((e) => e.paid)
                                                        .toList()
                                                        .map((d) => d.startTime)
                                                        .toList(),
                                                    yData: statsRidesRecordList
                                                        .where((e) => e.paid)
                                                        .toList()
                                                        .map((d) => d.price)
                                                        .toList(),
