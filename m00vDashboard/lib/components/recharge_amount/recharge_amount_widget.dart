...
import 'recharge_amount_model.dart';
export 'recharge_amount_model.dart';
...
class _RechargeAmountWidgetState extends State<RechargeAmountWidget> {
  late RechargeAmountModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RechargeAmountModel());
              ...
              FFButtonWidget(
                onPressed: () async {
                  await widget.userRef!.update(createUsersRecordData(
                    coins: double.tryParse(_model.textController.text),
                  ));
                  Navigator.pop(context);
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        'Amount in user\'s wallet updated',
                        style: TextStyle(
