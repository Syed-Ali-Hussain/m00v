...
class RidesRecord extends FirestoreRecord {
  ...
  List<LatLng> get dropoffPoints => _dropoffPoints ?? const [];
  bool hasDropoffPoints() => _dropoffPoints != null;

  // "dropoffNames" field.
  List<String>? _dropoffNames;
  List<String> get dropoffNames => _dropoffNames ?? const [];
  bool hasDropoffNames() => _dropoffNames != null;
  ...
  void _initializeFields() {
    ...
    _dropoffPoints = getDataList(snapshotData['dropoffPoints']);
    _dropoffNames = getDataList(snapshotData['dropoffNames']);
  }
...
class RidesRecordDocumentEquality implements Equality<RidesRecord> {
  ...
  bool equals(RidesRecord? e1, RidesRecord? e2) {
    ...
    return e1?.startTime == e2?.startTime &&
        ...
        e1?.paidAt == e2?.paidAt &&
        listEquality.equals(e1?.dropoffPoints, e2?.dropoffPoints) &&
        listEquality.equals(e1?.dropoffNames, e2?.dropoffNames);
  }
