...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color accent1 = const Color(0x4C080810);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFF87161D);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryBackground = const Color(0xFF0F161B);
  late Color secondaryBackground = const Color(0xFF1D2428);
  late Color accent1 = const Color(0x4CE9E7FA);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
